...
That said within the subset of continuous variables used to determine correlation on whether a loan was defaulted or charged off, there does not seem to be any variables in this subset that very strongly correlate with a loan being charged off or in default.  Interest rate and Grade have the largest correlation.
...
The formats are inconsistent across years 
Fico scores do not seem to exist in the 2015 table
